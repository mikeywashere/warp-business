...
public class AuthService
{
    ...
    public Guid GetCustomerIdFromJwt()
    {
        ...
        if (subClaim is null || !Guid.TryParse(subClaim.Value, out var customerId))
        {
            _logger.LogWarning("[AuthService] Failed to extract customer ID from 'sub' claim");
            return Guid.Empty;
        }
