...
using WarpBusiness.TenantPortal.Components;
...
.AddOpenIdConnect(options =>
{
    ...
    options.ClientId = "warpbusiness-tenant-portal";
    ...
    options.Events = new OpenIdConnectEvents
    {
        ...
        OnRedirectToIdentityProviderForSignOut = async context =>
        {
            ...
            context.ProtocolMessage.ClientId = "warpbusiness-tenant-portal";
...
{
    options.AddPolicy("TenantPortalAccess", policy =>
        policy.RequireAuthenticatedUser().RequireRole("tenant_portal"));
});
...
builder.Services.AddHttpClient<TenantPortalApiClient>(configureApiClient)
...
app.MapRazorComponents<App>()
    ...
    .RequireAuthorization("TenantPortalAccess");
