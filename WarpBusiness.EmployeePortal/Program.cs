...
using WarpBusiness.EmployeePortal.Components;
using WarpBusiness.EmployeePortal.Services;
...
.AddOpenIdConnect(options =>
{
    ...
    options.ClientId = "warpbusiness-employee-portal";
    ...
    options.Events = new OpenIdConnectEvents
    {
        ...
        OnRedirectToIdentityProviderForSignOut = async context =>
        {
            ...
            context.ProtocolMessage.ClientId = "warpbusiness-employee-portal";
...
{
    options.AddPolicy("EmployeePortalAccess", policy =>
        policy.RequireAuthenticatedUser().RequireRole("employee_portal"));
});
...
builder.Services.AddHttpClient<EmployeePortalApiClient>(configureApiClient)
