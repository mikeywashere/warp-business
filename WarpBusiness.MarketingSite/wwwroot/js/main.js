  ...
  var plugins = [
    ...
    },
    {
    ...
    },
      {
          ...
          tagline: 'Time Management at Scale',
          description: 'Time management for your whole team, billing for their time onsite.',
          badge: 'Available Now',
      },
      {
          icon: '🧾',
          name: 'Invoicing',
          tagline: 'Invoicing',
          description: 'Invoice your customers accurately and efficiently.',
          badge: 'Available Now',
      },
      {
          icon: '📘',
          ...
          description: 'A full catalog of all of your products.',
          badge: 'Available Now',
      },
      {
          icon: '🌐',
          ...
          description: 'Give customers direct access to their data and communications.',
          badge: 'Available Now',
      },
  ];
